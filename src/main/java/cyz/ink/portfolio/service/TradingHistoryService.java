...
public class TradingHistoryService {
    ...
    public int add(int instrumentId, int volume, float price, FundManager fundManager) {
        ...
        tradingHistory.setInstrument(instrumentService.get(instrumentId));
    ...
    public Page<TradingHistory> list(int fundManagerId, int start, int size) {
        ...
        FundManager fundManager = fundManagerService.get(fundManagerId);
        Page<TradingHistory> tradingHistories = tradingHistoryDAO.findAllByFundManager(fundManager, pageable);
