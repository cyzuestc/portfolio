...
public class CurrentPriceController {
    ...
    @GetMapping(value = "/getCurrentPriceByInstrumentId")
    public CurrentPrice getCurrentPriceByType(@RequestParam(name = "id", defaultValue = "0") int instrumentId) {
        return instrumentService.get(instrumentId).getCurrentPrice();
    }
}
